                ...
                <div class="sm:flex sm:items-center sm:justify-between">
                    <div class="sm:flex sm:space-x-5">
                        ...
                        <div class="mt-4 text-center sm:mt-0 sm:pt-1 sm:text-left">
                            ...
                            <p class="text-xl font-bold text-gray-900 sm:text-2xl">{{ $page.props.auth.user.firstname }} {{ $page.props.auth.user.lastname }}</p>
                            <p class="text-sm font-medium text-gray-600">{{ $page.props.auth.user.roles[0]?.name }}</p>
                        </div>
                    </div>
